...
object MoreCommand : CommandBase<CommandsConfig.Commands.More>(
    ...
    override fun execute(
        ...
        if (senderPlayer.getHeldItem(Hand.MAIN_HAND).count < senderPlayer.getHeldItem(Hand.MAIN_HAND).maxStackSize) {
            senderPlayer.getHeldItem(Hand.MAIN_HAND).count = senderPlayer.getHeldItem(Hand.MAIN_HAND).maxStackSize
